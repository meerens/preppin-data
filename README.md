...
| 2022-WK33 | C&BSCo Next Sale             | [UNION ALL](https://cloud.google.com/bigquery/docs/reference/standard-sql/query-syntax#set_operators) - [SPLIT](https://cloud.google.com/bigquery/docs/reference/standard-sql/string_functions#split) - [ORDINAL](https://cloud.google.com/bigquery/docs/reference/standard-sql/mathematical_functions#round) - [LEAD](https://cloud.google.com/bigquery/docs/reference/standard-sql/navigation_functions#lead)                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | [Challenge](https://preppindata.blogspot.com/2022/08/2022-week-33-c-next-sale.html)                | [Solution Notebook](https://count.co/notebook/BHLe4x6IZJN) | Unioning tables (tables don’t have the same number of columns), importance of the order of operations, determining the next value in bringing it back to same row              |
